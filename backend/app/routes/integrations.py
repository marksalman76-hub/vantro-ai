...
INTEGRATION_CATALOGUE = [
    ...
    {"key": "HEYGEN_API_KEY",              "name": "HeyGen",          "category": "media",      "description": "AI avatar video generation", "test_method": "http_get"},
    {"key": "ELEVENLABS_API_KEY",          "name": "ElevenLabs",      "category": "media",      "description": "AI voice synthesis and cloning", "test_method": "http_get"},
    {"key": "RUNWAY_API_KEY",              "name": "Runway",          "category": "media",      "description": "AI text-to-video generation", "test_method": "key_present"},
    ...
    if method == "http_get":
        try:
            ...
            test_urls = {
                ...
                "HEYGEN_API_KEY":     ("https://api.heygen.com/v2/avatars?limit=1", {"X-Api-Key": raw_value}),
