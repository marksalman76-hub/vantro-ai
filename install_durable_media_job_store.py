...
TARGET = RUNTIME_DIR / "durable_media_job_store.py"
TEST = ROOT / "test_durable_media_job_store.py"
BACKUP_DIR = ROOT / "backups" / f"durable_media_job_store_before_{datetime.now().strftime('%Y%m%d_%H%M%S')}"
...
TEST.write_text(r'''from backend.app.runtime.durable_media_job_store import get_media_job_store
...
print("DURABLE_MEDIA_JOB_STORE_INSTALLED")
