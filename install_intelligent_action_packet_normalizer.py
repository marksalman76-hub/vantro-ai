...
ROOT = Path.cwd()
BACKUP = ROOT / "backups" / f"intelligent_action_packet_normalizer_before_{datetime.now().strftime('%Y%m%d_%H%M%S')}"
BACKUP.mkdir(parents=True, exist_ok=True)

runtime_dir = ROOT / "backend" / "app" / "runtime"
runtime_dir.mkdir(parents=True, exist_ok=True)

target = runtime_dir / "intelligent_action_packet_normalizer.py"
if target.exists():
...
test_file = ROOT / "test_intelligent_action_packet_normalizer.py"
...
print("INTELLIGENT_ACTION_PACKET_NORMALIZER_INSTALLED")
