...
backup = backup_dir / f"client_page_before_force_compact_profile_{datetime.now().strftime('%Y%m%d_%H%M%S')}.tsx"
...
new_block = r'''{activeAccountPanel === "profile" ? (
                <div style={{
                  gridColumn: "1 / -1",
                  display: "grid",
                  gridTemplateColumns: "1.2fr 1fr 170px",
                  gap: 16,
                  alignItems: "center",
                  ...
                  <div>
                    <div style={{ fontSize: 11, color: "var(--color-muted)", fontWeight: 900, textTransform: "uppercase", marginBottom: 6 }}>
                      Client
                    </div>
                    <input
                      type="text"
...
print("FORCE_COMPACT_PROFILE_PANEL_LAYOUT_DONE")
