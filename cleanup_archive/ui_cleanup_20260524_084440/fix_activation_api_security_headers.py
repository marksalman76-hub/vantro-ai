...
backup = BACKUP_DIR / f"activate_api_before_security_headers_{datetime.now().strftime('%Y%m%d_%H%M%S')}.ts"
backup.write_text(text, encoding="utf-8")

new = r'''import { NextRequest, NextResponse } from "next/server";
...
print("ACTIVATION_API_SECURITY_HEADERS_FIXED")
