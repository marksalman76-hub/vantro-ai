...
backup = BACKUPS / f"test_step239_before_step240_cache_proof_{timestamp}.py"
...
print("STEP_240_CACHE_PROOF_COMMERCIAL_LOCK_RESULTS")
...
print("STEP_240_CACHE_PROOF_COMMERCIAL_LOCK_OK")
'''.lstrip(), encoding="utf-8")

py_compile.compile(str(TEST), doraise=True)

print("STEP_240_CACHE_PROOF_FINAL_COMMERCIAL_LOCK_INSTALLED")
