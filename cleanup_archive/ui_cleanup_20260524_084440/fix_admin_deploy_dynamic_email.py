...
backup = BACKUP_DIR / f"admin_page_before_dynamic_deploy_email_{datetime.now().strftime('%Y%m%d_%H%M%S')}.tsx"
...
if old not in text:
    raise SystemExit("DEPLOY_CLIENT_FUNCTION_TARGET_NOT_FOUND")
...
print("ADMIN_DEPLOY_DYNAMIC_EMAIL_FIXED")
