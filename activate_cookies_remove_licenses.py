...
COOKIES_PAGE = ROOT / "frontend" / "src" / "app" / "cookies" / "page.tsx"
BACKUP_DIR = ROOT / "backups"
BACKUP_DIR.mkdir(exist_ok=True)

stamp = datetime.now().strftime("%Y%m%d_%H%M%S")
backup = BACKUP_DIR / f"page_before_cookies_remove_licenses_{stamp}.tsx"
shutil.copy2(PAGE, backup)

s = PAGE.read_text(encoding="utf-8")

s = s.replace(
    '["Terms","/terms-of-service"],["Privacy","/privacy-policy"],["Cookies","/privacy-policy"],["Licenses","/terms-of-service"]',
    '["Terms","/terms-of-service"],["Privacy","/privacy-policy"],["Cookies","/cookies"]'
)

PAGE.write_text(s, encoding="utf-8")

COOKIES_PAGE.parent.mkdir(parents=True, exist_ok=True)
COOKIES_PAGE.write_text(r'''"use client";
...
print("COOKIES_PAGE_ACTIVATED_AND_LICENSES_REMOVED")
