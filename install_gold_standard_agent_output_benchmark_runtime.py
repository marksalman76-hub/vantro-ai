...
target = runtime_dir / "gold_standard_agent_output_benchmark_runtime.py"
test_file = ROOT / "test_gold_standard_agent_output_benchmark_runtime_direct.py"

backup_dir = ROOT / "backups" / f"gold_standard_agent_output_benchmark_before_{STAMP}"
...
print("GOLD_STANDARD_AGENT_OUTPUT_BENCHMARK_RUNTIME_INSTALLED")
