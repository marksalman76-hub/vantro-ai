...
target = Path("backend/app/runtime/post_deploy_validation_readiness.py")

backup_dir = Path("backups") / ("post_deploy_validation_readiness_before_" + datetime.now().strftime("%Y%m%d_%H%M%S"))
...
print("POST_DEPLOY_VALIDATION_READINESS_INSTALLED")
