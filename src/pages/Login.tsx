  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (token) {
        ...
        setError((result.detail as string) || 'Login failed. Check your credentials.')
      }
    } catch {
        ...
        <form onSubmit={handleLogin} noValidate>
          ...
          <div style={{ textAlign: 'right', marginBottom: '1.5rem' }}>
            <span
              ...
              onMouseEnter={(e) =>
                ((e.currentTarget as HTMLSpanElement).style.color = 'oklch(0.70 0 0)')
              }
              onMouseLeave={(e) =>
                ((e.currentTarget as HTMLSpanElement).style.color = 'oklch(0.55 0 0)')
              }
            >
              Forgot password?
            </span>
