    ...
    >
      ...
      >
        <span
          ...
          style={{ color: 'oklch(0.62 0.22 248)', fontFamily: 'Georgia, serif', verticalAlign: '-0.2em' }}
        >
          &ldquo;
        </span>
        {quote.text}
...
export function Testimonials() {
  return (
    <section className="py-32 overflow-hidden" style={{ backgroundColor: 'oklch(0.09 0.04 260)' }}>
      <h2
