...
TEMPLATES = RUNTIME_DIR / "ai_media_prompt_template_pack.py"
TEST_FILE = ROOT / "test_ai_media_prompt_template_pack.py"
IMPORT_TEST = ROOT / "test_ai_media_prompt_template_pack_admin_endpoints_import.py"
...
backup = BACKUPS / f"main_before_ai_media_prompt_template_pack_{ts}.py"
backup.write_text(MAIN.read_text(encoding="utf-8"), encoding="utf-8")

TEMPLATES.write_text(r'''
...
import_line = "from backend.app.runtime.ai_media_prompt_template_pack import ai_media_prompt_template_pack_readiness, list_ai_media_prompt_templates, list_rendered_ai_media_prompts, recommend_ai_media_prompt_template, render_ai_media_prompt_template\n"
...
if "/admin/ai-media-templates/readiness" not in main_text:
...
print("AI_MEDIA_PROMPT_TEMPLATE_PACK_INSTALLED")
print(f"Backup: {backup}")
print(f"Created/updated: {TEMPLATES}")
print(f"Created/updated: {TEST_FILE}")
print(f"Created/updated: {IMPORT_TEST}")
print("Routes:")
print("/admin/ai-media-templates/readiness")
print("/admin/ai-media-templates/list")
print("/admin/ai-media-templates/recommend")
print("/admin/ai-media-templates/render")
print("/admin/ai-media-templates/rendered")