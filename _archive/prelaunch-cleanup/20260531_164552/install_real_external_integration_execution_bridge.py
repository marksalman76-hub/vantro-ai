...
ROOT = Path.cwd()
BACKUP = ROOT / "backups" / f"real_external_integration_execution_bridge_before_{datetime.now().strftime('%Y%m%d_%H%M%S')}"
BACKUP.mkdir(parents=True, exist_ok=True)

runtime_dir = ROOT / "backend" / "app" / "runtime"
runtime_dir.mkdir(parents=True, exist_ok=True)

target = runtime_dir / "real_external_integration_execution_bridge.py"
...
test_file = ROOT / "test_real_external_integration_execution_bridge.py"
...
print("REAL_EXTERNAL_INTEGRATION_EXECUTION_BRIDGE_INSTALLED")
