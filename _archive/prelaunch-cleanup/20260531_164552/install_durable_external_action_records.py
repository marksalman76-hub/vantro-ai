...
ROOT = Path.cwd()
BACKUP = ROOT / "backups" / f"durable_external_action_records_before_{datetime.now().strftime('%Y%m%d_%H%M%S')}"
BACKUP.mkdir(parents=True, exist_ok=True)

runtime_dir = ROOT / "backend" / "app" / "runtime"
runtime_dir.mkdir(parents=True, exist_ok=True)

target = runtime_dir / "durable_external_action_records.py"
if target.exists():
...
test_file = ROOT / "test_durable_external_action_records.py"
...
print("DURABLE_EXTERNAL_ACTION_RECORDS_INSTALLED")
