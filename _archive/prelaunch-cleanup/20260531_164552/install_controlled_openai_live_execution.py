...
BACKUP = ROOT / "backups" / "production" / f"controlled_openai_live_execution_before_{STAMP}"
...
write("scripts/activation/controlled-openai-live-execution.py", r"""
from pathlib import Path
from datetime import datetime
import json
import os
...
write("scripts/activation/controlled-openai-live-execution-check.js", r"""
