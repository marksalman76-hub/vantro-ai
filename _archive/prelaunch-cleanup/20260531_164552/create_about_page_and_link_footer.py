...
ABOUT_PAGE = ROOT / "frontend" / "src" / "app" / "about" / "page.tsx"
BACKUP_DIR = ROOT / "backups"
BACKUP_DIR.mkdir(exist_ok=True)

stamp = datetime.now().strftime("%Y%m%d_%H%M%S")
backup = BACKUP_DIR / f"page_before_about_route_{stamp}.tsx"
...
ABOUT_PAGE.write_text(r'''"use client";
...
print("ABOUT_PAGE_CREATED_AND_FOOTER_LINKED")
