...
p = Path("backend/app/runtime/shared_creative_media_generation_runtime.py")
...
from backend.app.runtime.ai_media_multi_provider_execution_packets import (
    build_ai_media_execution_packet,
)
...
print("SHARED_CREATIVE_MEDIA_GENERATION_RUNTIME_INSTALLED")