...
ADAPTERS = RUNTIME_DIR / "ai_media_provider_adapters.py"
TEST_FILE = ROOT / "test_ai_media_provider_adapters.py"
IMPORT_TEST = ROOT / "test_ai_media_provider_adapters_admin_endpoints_import.py"
...
backup = BACKUPS / f"main_before_ai_media_provider_adapters_{ts}.py"
...
import_line = "from backend.app.runtime.ai_media_provider_adapters import ai_media_provider_adapters_readiness, execute_ai_media_provider_adapter, get_provider_adapter_status, list_ai_media_provider_adapter_results, prepare_provider_payload\n"
...
if "/admin/ai-media-adapters/readiness" not in main_text:
...
print("AI_MEDIA_PROVIDER_ADAPTER_STUBS_INSTALLED")
print(f"Backup: {backup}")
print(f"Created/updated: {ADAPTERS}")
print(f"Created/updated: {TEST_FILE}")
print(f"Created/updated: {IMPORT_TEST}")
print("Routes:")
print("/admin/ai-media-adapters/readiness")
print("/admin/ai-media-adapters/status")
print("/admin/ai-media-adapters/prepare")
print("/admin/ai-media-adapters/execute")
print("/admin/ai-media-adapters/results")