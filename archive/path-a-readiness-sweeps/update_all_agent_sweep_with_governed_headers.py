...
OUT = ROOT / "all_agent_live_readiness_sweep_v3.cmd"
...
lines = [
    ...
    "echo ALL_AGENT_LIVE_READINESS_SWEEP_V3_STARTED",
]

for n, agent in enumerate(AGENTS, start=1):
    request_id = f"owner-admin-agent-sweep-v3-{n:02d}-{agent}"
    lines += [
        f"echo ==================== {agent} ====================",
        (
            ...
            "-H \"x-actor-role: owner_admin\" "
            "-H \"x-tenant-id: owner_admin_test\" "
...
lines += ["echo ALL_AGENT_LIVE_READINESS_SWEEP_V3_COMPLETE"]

OUT.write_text("\n".join(lines), encoding="utf-8")

print("ALL_AGENT_LIVE_READINESS_SWEEP_V3_CREATED")
print("Run this next:")
print("all_agent_live_readiness_sweep_v3.cmd")