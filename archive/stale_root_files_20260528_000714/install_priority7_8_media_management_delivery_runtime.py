...
runtime_file = RUNTIME / "ai_media_management_delivery_runtime.py"
test_file = ROOT / "test_priority7_8_media_management_delivery_runtime.py"

if runtime_file.exists():
    (BACKUPS / f"ai_media_management_delivery_runtime_before_priority7_8_{stamp}.py").write_text(
...
print("PRIORITY7_8_MEDIA_MANAGEMENT_DELIVERY_RUNTIME_INSTALLED")
