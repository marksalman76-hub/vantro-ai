...
runtime_file = RUNTIME / "ai_media_character_dubbing_runtime.py"
test_file = ROOT / "test_priority5_6_character_dubbing_runtime.py"

if runtime_file.exists():
    (BACKUPS / f"ai_media_character_dubbing_runtime_before_priority5_6_{stamp}.py").write_text(
...
print("PRIORITY5_6_CHARACTER_DUBBING_RUNTIME_INSTALLED")
