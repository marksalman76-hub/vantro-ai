...
for agent_id in AGENTS:
    payload = {
        ...
        "workflow_stage": "registry_execution_test",
        "requested_agent": agent_id,
        "task": f"Registry certification test for {agent_id}",
    ...
    try:
        ...
        if (
            ...
            and data.get("error") != "unknown_agent"
        ):
...
print("\n")
print("REGISTRY_EXECUTION_CERTIFICATION_RESULTS")
...
if len(failed) == 0:
    print("REGISTRY_CERTIFICATION_PASSED")