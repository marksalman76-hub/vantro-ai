...
PACKETS = RUNTIME_DIR / "ai_media_multi_provider_execution_packets.py"
TEST_FILE = ROOT / "test_ai_media_multi_provider_execution_packets.py"
IMPORT_TEST = ROOT / "test_ai_media_multi_provider_execution_packets_admin_endpoints_import.py"
...
backup = BACKUPS / f"main_before_ai_media_multi_provider_packets_{ts}.py"
backup.write_text(MAIN.read_text(encoding="utf-8"), encoding="utf-8")

PACKETS.write_text(r'''
...
import_line = "from backend.app.runtime.ai_media_multi_provider_execution_packets import advance_packet_to_next_provider, ai_media_multi_provider_packets_readiness, create_ai_media_multi_provider_packet, list_ai_media_multi_provider_packets\n"
...
if "/admin/ai-media-packets/readiness" not in main_text:
...
print("AI_MEDIA_MULTI_PROVIDER_EXECUTION_PACKETS_INSTALLED")
print(f"Backup: {backup}")
print(f"Created/updated: {PACKETS}")
print(f"Created/updated: {TEST_FILE}")
print(f"Created/updated: {IMPORT_TEST}")
print("Routes:")
print("/admin/ai-media-packets/readiness")
print("/admin/ai-media-packets/create")
print("/admin/ai-media-packets/advance-provider")
print("/admin/ai-media-packets/list")