...
target = runtime_dir / "real_agent_component_catalogue.py"
test_file = ROOT / "test_real_agent_component_catalogue_direct.py"

backup_dir = ROOT / "backups" / f"real_agent_component_catalogue_before_{STAMP}"
...
print("REAL_AGENT_COMPONENT_CATALOGUE_INSTALLED")
