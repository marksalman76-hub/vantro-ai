...
target = runtime_dir / "signup_locked_activation_bridge.py"
test_file = ROOT / "test_signup_locked_activation_bridge_direct.py"

backup_dir = ROOT / "backups" / f"signup_locked_activation_bridge_before_{STAMP}"
...
print("SIGNUP_LOCKED_ACTIVATION_BRIDGE_INSTALLED")
