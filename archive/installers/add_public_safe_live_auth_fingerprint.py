...
backup_file = backups / f"main_before_public_safe_live_auth_fingerprint_{timestamp}.py"
...
if "/system/live-auth-fingerprint" not in content:
    content = content.rstrip() + "\n" + route_block.strip() + "\n"

main_file.write_text(content, encoding="utf-8")

test_file = ROOT / "test_public_safe_live_auth_fingerprint_import.py"
...
print("PUBLIC_SAFE_LIVE_AUTH_FINGERPRINT_ADDED")
