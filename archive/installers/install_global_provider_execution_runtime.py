...
runtime_file = RUNTIME / "global_provider_execution_runtime.py"
test_file = ROOT / "test_global_provider_execution_runtime.py"

if runtime_file.exists():
    (BACKUPS / f"global_provider_execution_runtime_before_{stamp}.py").write_text(
...
print("GLOBAL_PROVIDER_EXECUTION_RUNTIME_INSTALLED")
