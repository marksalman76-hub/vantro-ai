...
ORCH_FILE = CORE / "multi_agent_orchestration_runtime.py"

timestamp = datetime.now().strftime("%Y%m%d_%H%M%S")
main_text = MAIN.read_text(encoding="utf-8")

backup = BACKUPS / f"main_before_priority6_orchestration_runtime_{timestamp}.py"
...
ORCH_FILE.write_text(orch_code.strip() + "\n", encoding="utf-8")

import_line = "from backend.app.core.multi_agent_orchestration_runtime import orchestration_readiness, create_orchestration_plan\n"
...
if "/admin/orchestration/readiness" not in main_text:
    main_text = main_text.rstrip() + "\n\n" + routes + "\n"

MAIN.write_text(main_text, encoding="utf-8")

print("PRIORITY6_ORCHESTRATION_RUNTIME_INSTALLED")
print(f"Backup: {backup}")
print(f"Created/updated: {ORCH_FILE}")
print("Routes:")
print("/admin/orchestration/readiness")
print("/admin/orchestration/create-plan")