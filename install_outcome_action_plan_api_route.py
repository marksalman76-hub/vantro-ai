...
backup = ROOT / "backups" / f"outcome_action_plan_api_route_before_{datetime.now().strftime('%Y%m%d_%H%M%S')}"
backup.mkdir(parents=True, exist_ok=True)

if api_file.exists():
    shutil.copy2(api_file, backup / "route.ts")
...
print("OUTCOME_ACTION_PLAN_API_ROUTE_INSTALLED")
