      ...
      <div style={shellStyle}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(150px,1fr))", gap: 12, marginTop: 18 }}>
            {(integrations.length ? integrations : DEFAULT_CLIENT_INTEGRATIONS).map((integration) => (
              <div key={integration.integration_key} style={{ border: "1px solid rgba(15,23,42,0.08)", borderRadius: 18, padding: 12,
                ...
                <div style={{ marginTop: 6, color: "#64748b", fontSize: 10.5, lineHeight: 1.25 }}>
                  Used by active agents
                </div>
                <div style={{ marginTop: 4, color: "#64748b", fontSize: 10.5, lineHeight: 1.25 }}>
                  Provider ready
                </div>
                <div style={{ marginTop: 4, color: "#64748b", fontSize: 10.5, lineHeight: 1.25 }}>
                  Secure connection
                ...
                <div style={{ marginTop: 12, display: "flex", gap: 8, flexWrap: "wrap" }}>
                  <button type="button" onClick={() => connectIntegration(integration)} style={{ border: "1px solid rgba(37, 99, 235, 0.14)", background: "linear-gradient(135deg, rgba(239, 246, 255, 0.86), rgba(255, 255, 255, 0.96))", color: "#2563eb", borderRadius: 11, padding: "6px 9px", fontWeight: 760, cursor: "pointer" }}>
                    Connect
                  </button>
                  <button type="button" onClick={() => testIntegration(integration)} style={{ border: "1px solid #e5eaf2", background: "#fff", color: "#334155", borderRadius: 11, padding: "6px 9px", fontWeight: 760, cursor: "pointer" }}>
                    Test
                  </button>
                  <button type="button" onClick={() => disconnectIntegration(integration)} style={{ border: "1px solid #fee2e2", background: "#fff", color: "#dc2626", borderRadius: 11, padding: "6px 9px", fontWeight: 760, cursor: "pointer" }}>
                    Disconnect
                  </button>
                </div>
              </div>
        ...
        <section style={responsiveWorkspaceGridStyle}>
          <div style={cardStyle}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "280px minmax(0,1fr)", gap: 18, marginTop: 18 }}>
              <div>
