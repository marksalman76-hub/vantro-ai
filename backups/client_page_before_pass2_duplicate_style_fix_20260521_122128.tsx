    ...
    >
      <div style={shellStyle}>
        ...
        <section style={cardStyle}>
          ...
          {integrationMessage ? (
            <div style={{ marginTop: 14, padding: "16px 18px", borderRadius: 14, background: "linear-gradient(135deg, rgba(239, 246, 255, 0.86), rgba(255, 255, 255, 0.96))", color: "#2563eb", fontWeight: 700 }}>
              {integrationMessage}
            </div>
          ) : null}
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(240px,1fr))", gap: 12, marginTop: 18 }}>
            {(integrations.length ? integrations : DEFAULT_CLIENT_INTEGRATIONS).map((integration) => (
              <div key={integration.integration_key} style={{ border: "1px solid #e5eaf2", borderRadius: 18, padding: 20,
                      minHeight: "100%", background: "#fff" }}>
                <div style={{ display: "flex", justifyContent: "space-between", gap: 10, alignItems: "flex-start" }}>
                  <div>
                    <div style={{ fontWeight: 760, color: "#0f172a" }}>{integration.name}</div>
                ...
                <div style={{ marginTop: 12, display: "flex", gap: 8, flexWrap: "wrap" }}>
                  <button type="button" onClick={() => connectIntegration(integration)} style={{ border: "1px solid rgba(37, 99, 235, 0.14)", background: "linear-gradient(135deg, rgba(239, 246, 255, 0.86), rgba(255, 255, 255, 0.96))", color: "#2563eb", borderRadius: 11, padding: "8px 10px", fontWeight: 760, cursor: "pointer" }}>
                    Connect
                  </button>
                  <button type="button" onClick={() => testIntegration(integration)} style={{ border: "1px solid #e5eaf2", background: "#fff", color: "#334155", borderRadius: 11, padding: "8px 10px", fontWeight: 760, cursor: "pointer" }}>
                    Test
                  </button>
                  <button type="button" onClick={() => disconnectIntegration(integration)} style={{ border: "1px solid #fee2e2", background: "#fff", color: "#dc2626", borderRadius: 11, padding: "8px 10px", fontWeight: 760, cursor: "pointer" }}>
                    Disconnect
                  </button>
                </div>
              </div>
        ...
        <section style={responsiveWorkspaceGridStyle}>
          <div style={cardStyle}>
            ...
            <h3 style={cardTitle}>Select approved agents, define a business objective, and launch governed execution.</h3>

            <div style={{ display: "grid", gridTemplateColumns: "minmax(260px,360px) minmax(320px,1fr)", gap: 18, marginTop: 18 }}>
              <div>
                <div style={labelStyle}>Purchased & active agents</div>
          ...
          <div style={cardStyle}>
            ...
            <h3 style={cardTitle}>Execution deliverables</h3>
            <p style={mutedText}>
          ...
          <div style={cardStyle}>
            ...
            <h3 style={cardTitle}>Workspace controls</h3>
        ...
        <section style={responsiveSecondaryGridStyle}>
          <div style={cardStyle}>
            <StepHeader number="05" title="Activity feed" />
            <h3 style={cardTitle}>Activity feed</h3>
            <p style={{ color: "#2563eb", fontWeight: 700, fontSize: 13 }}>Governed activity tracking connected</p>
                ...
                return (
                  ...
                  >
                    <div style={{ display: "flex", justifyContent: "space-between", gap: 14, flexWrap: "wrap", alignItems: "flex-start" }}>
                      <div>
                        <div style={{ color: "#64748b", fontSize: 12.5, fontWeight: 700 }}>{time}</div>
                      ...
                      <div style={{ textAlign: "right", color: "#64748b", fontSize: 13, fontWeight: 850 }}>
                        <div>{agentName}</div>
                        <div style={{ marginTop: 8, display: "inline-flex", background: statusTone.bg, color: statusTone.text, border: `1px solid ${statusTone.border}`, borderRadius: 999, padding: "6px 9px", fontSize: 11.5, fontWeight: 800 }}>
                          {statusTone.label}
                        </div>
                      </div>
                    </div>
                    ...
                    <div style={{ display: "flex", flexWrap: "wrap", gap: 8, marginTop: 14 }}>
                      <span style={{ background: "linear-gradient(135deg, rgba(239, 246, 255, 0.86), rgba(255, 255, 255, 0.96))", color: "#2563eb", border: "1px solid rgba(37, 99, 235, 0.14)", borderRadius: 999, padding: "7px 10px", fontWeight: 850, fontSize: 12 }}>
                    ...
                    backdropFilter: "blur(10px)",
                    WebkitBackdropFilter: "blur(10px)",
                    borderRadius: 999, padding: "7px 10px", fontWeight: 850, fontSize: 12 }}>
          ...
          <div style={cardStyle}>
            ...
            <div style={deliverableCardGridStyle}>
              ...
              <div style={{ minWidth: 0 }}>
                ...
                <div style={{ display: "flex", gap: 16, alignItems: "flex-start", flexWrap: "wrap", alignItems: "center" }}>
                  <button
                    onClick={() => setShowDeliverableModal(true)}
                    style={{
                      border: "1px solid rgba(37, 99, 235, 0.14)",
          ...
          >
            ...
            <div style={modalContentGridStyle}>
              ...
              <div style={{ minWidth: 0 }}>
                ...
                <div style={{ display: "flex", gap: 16, alignItems: "flex-start", flexWrap: "wrap", justifyContent: "flex-end", alignItems: "center" }}>
                  <button
                    onClick={() => setShowDeliverableModal(false)}
                    style={{
                      border: "1px solid #e5eaf2",
