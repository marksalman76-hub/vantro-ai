      ...
      <section style={{ maxWidth: 1280, margin: "0 auto" }}>
        ...
        >
          <div>
            ...
            <h1 style={{ fontSize: 52, marginTop: 10, lineHeight: 1.02 }}>
        ...
        <div style={{ ...cardStyle, padding: 24, marginTop: 24 }}>
          ...
          >
            <div>
              ...
              >
                Add store context once so every active agent can produce more accurate,
                premium ecommerce work.
              </p>
            </div>
          ...
          >
            {businessFields.map(([label, key, placeholder]) => (
              <label key={key}>
                <div style={{ color: "#94a3b8", fontSize: 12, marginBottom: 7 }}>
                  {label}
                </div>
