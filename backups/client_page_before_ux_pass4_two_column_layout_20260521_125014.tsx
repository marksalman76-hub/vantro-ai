    ...
    >
      <div style={shellStyle}>
        ...
        <section style={cardStyle}>
          ...
          {integrationMessage ? (
            <div style={{ marginTop: 14, padding: "12px 14px", borderRadius: 999, background: "linear-gradient(135deg, rgba(239, 246, 255, 0.86), rgba(255, 255, 255, 0.96))", color: "#2563eb", fontWeight: 700 }}>
              {integrationMessage}
            </div>
          ) : null}
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(240px,1fr))", gap: 12, marginTop: 18 }}>
            {(integrations.length ? integrations : DEFAULT_CLIENT_INTEGRATIONS).map((integration) => (
              <div key={integration.integration_key} style={{ border: "1px solid #e5eaf2", borderRadius: 16, padding: 20,
        ...
        <section style={responsiveWorkspaceGridStyle}>
          <div style={cardStyle}>
            ...
            <h3 style={cardTitle}>Select approved agents and launch governed execution.</h3>
          ...
          <div style={cardStyle}>
            ...
            <div style={{ display: "grid", gap: 11, marginTop: 20 }}>
              {["History", "Workflows", "Performance", "Settings"].map((item) => (
                <button
                  key={item}
                  style={{
                    border: "1px solid #e5eaf2",
