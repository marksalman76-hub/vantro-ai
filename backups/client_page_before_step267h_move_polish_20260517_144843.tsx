...
<section className="rounded-3xl border border-cyan-400/20 bg-cyan-400/[0.04] p-6 shadow-2xl">
          ...
          <div className="mt-5 grid gap-4 md:grid-cols-2">
            <textarea className="business-profile-field" placeholder="Business niche" value={businessProfile.niche} onChange={(event) => setBusinessProfile({ ...businessProfile, niche: event.target.value })} />
            <textarea className="business-profile-field" placeholder="Products and services" value={businessProfile.products_services} onChange={(event) => setBusinessProfile({ ...businessProfile, products_services: event.target.value })} />
            <textarea className="business-profile-field" placeholder="Target audience" value={businessProfile.target_audience} onChange={(event) => setBusinessProfile({ ...businessProfile, target_audience: event.target.value })} />
            <textarea className="business-profile-field" placeholder="Competitors" value={businessProfile.competitors} onChange={(event) => setBusinessProfile({ ...businessProfile, competitors: event.target.value })} />
            <textarea className="business-profile-field" placeholder="Offers and promotions" value={businessProfile.offers} onChange={(event) => setBusinessProfile({ ...businessProfile, offers: event.target.value })} />
            <textarea className="business-profile-field" placeholder="Brand voice and tone" value={businessProfile.brand_voice} onChange={(event) => setBusinessProfile({ ...businessProfile, brand_voice: event.target.value })} />
            <textarea className="business-profile-field" placeholder="Market positioning" value={businessProfile.positioning} onChange={(event) => setBusinessProfile({ ...businessProfile, positioning: event.target.value })} />
            <textarea className="business-profile-field" placeholder="Business goals" value={businessProfile.goals} onChange={(event) => setBusinessProfile({ ...businessProfile, goals: event.target.value })} />
          </div>
        </section>
