      ...
      <div style={shellStyle}>
        ...
        >
          ...
          >
            {[
              ...
              <label key={label}>
                <div style={{ color: "#64748b", fontSize: 12.2, fontWeight: 700, marginBottom: 7 }}>
                  {label}
                </div>
                <textarea
                  defaultValue={value}
        ...
        >
          ...
          >
            <div>
              ...
              <div style={{ color: "#64748b", fontSize: 12.2, marginTop: 2 }}>Connected systems</div>
            </div>
        ...
        <section style={responsiveWorkspaceGridStyle}>
          <div style={cardStyle}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "245px minmax(0,1fr)", gap: 14, marginTop: 14 }}>
              <div>
                ...
                return (
                  ...
                  >
                    <div style={{ display: "flex", justifyContent: "space-between", gap: 14, flexWrap: "wrap", alignItems: "flex-start" }}>
                      <div>
                        <div style={{ color: "#64748b", fontSize: 12.2, fontWeight: 700 }}>{time}</div>
                        <div style={{ fontWeight: 800, color: "#0f172a", fontSize: 16, marginTop: 5 }}>
                          {event.title || event.event_type || "Execution event"}
                        </div>
                        <div style={{ color: "#475569", fontSize: 12.2, lineHeight: 1.45, marginTop: 6 }}>
              ...
              <div style={{ minWidth: 0 }}>
                ...
                {attachedAssets.length > 1 ? (
                  <div style={{ marginBottom: 16 }}>
                    <div style={{ color: "#64748b", fontSize: 12.2, fontWeight: 700, marginBottom: 8 }}>
                      Attached media
                    </div>
