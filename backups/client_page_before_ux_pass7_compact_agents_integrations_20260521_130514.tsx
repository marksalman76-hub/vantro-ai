    ...
    >
      <div style={shellStyle}>
        ...
        <section style={cardStyle}>
          ...
          {integrationMessage ? (
            <div style={{ marginTop: 14, padding: "12px 14px", borderRadius: 16, background: "linear-gradient(135deg, rgba(239, 246, 255, 0.86), rgba(255, 255, 255, 0.96))", color: "#2563eb", fontWeight: 700 }}>
              {integrationMessage}
            </div>
          ) : null}
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(180px,1fr))", gap: 12, marginTop: 18 }}>
            {(integrations.length ? integrations : DEFAULT_CLIENT_INTEGRATIONS).map((integration) => (
              <div key={integration.integration_key} style={{ border: "1px solid #e5eaf2", borderRadius: 16, padding: 18,
                ...
                <div style={{ marginTop: 12, color: "#64748b", fontSize: 11.5, lineHeight: 1.35 }}>
                  Used by active agents
                </div>
                <div style={{ marginTop: 8, color: "#64748b", fontSize: 11.5, lineHeight: 1.35 }}>
                  Provider ready
                </div>
                <div style={{ marginTop: 8, color: "#64748b", fontSize: 11.5, lineHeight: 1.35 }}>
                  Secure connection
                ...
                <div style={{ marginTop: 12, display: "flex", gap: 8, flexWrap: "wrap" }}>
                  <button type="button" onClick={() => connectIntegration(integration)} style={{ border: "1px solid rgba(37, 99, 235, 0.14)", background: "linear-gradient(135deg, rgba(239, 246, 255, 0.86), rgba(255, 255, 255, 0.96))", color: "#2563eb", borderRadius: 11, padding: "9px 12px", fontWeight: 760, cursor: "pointer" }}>
                    Connect
                  </button>
                  <button type="button" onClick={() => testIntegration(integration)} style={{ border: "1px solid #e5eaf2", background: "#fff", color: "#334155", borderRadius: 11, padding: "9px 12px", fontWeight: 760, cursor: "pointer" }}>
                    Test
                  </button>
                  <button type="button" onClick={() => disconnectIntegration(integration)} style={{ border: "1px solid #fee2e2", background: "#fff", color: "#dc2626", borderRadius: 11, padding: "9px 12px", fontWeight: 760, cursor: "pointer" }}>
                    Disconnect
                  </button>
                </div>
              </div>
        ...
        <section style={responsiveWorkspaceGridStyle}>
          <div style={cardStyle}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "minmax(300px, 0.92fr) minmax(360px, 1.08fr)", gap: 18, marginTop: 18 }}>
              <div>
              ...
              {(executionTimeline.length
                ...
                return (
                  ...
                  >
                    ...
                    minHeight: 120, lineHeight: 1.45, marginTop: 6 }}>
                      ...
                      <div style={{ textAlign: "right", color: "#64748b", fontSize: 13, fontWeight: 850 }}>
                        <div>{agentName}</div>
                        <div style={{ marginTop: 8, display: "inline-flex", background: statusTone.bg, color: statusTone.text, border: `1px solid ${statusTone.border}`, borderRadius: 16, padding: "6px 9px", fontSize: 11.5, fontWeight: 800 }}>
                          {statusTone.label}
                        </div>
                      </div>
                    </div>
