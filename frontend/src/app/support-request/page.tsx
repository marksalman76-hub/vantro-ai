...
export default function Page() {
  return (
    <InfoPage
      ...
      bullets={[
        'For billing or payment issues, include your business name and the email linked to your subscription.', 'For workspace or AI output issues, include the agent used, the task requested, and what needs to be changed.', 'For login, access, or 2FA issues, include the affected email address and the error you are seeing.', 'Support request form connection is ready for the next backend/email integration step.'
      ]}
    />
  );
}
