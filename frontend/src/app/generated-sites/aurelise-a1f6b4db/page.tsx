      ...
      <section className="hero">
        ...
        <div className="left">
          ...
          <div className="eyebrow">
            Luxury Ritual · beauty_editorial
          </div>
        ...
        * {
        ...
        .shell {
          ...
          background:
            ...
            radial-gradient(circle at 20% 10%, #f472b666, transparent 35%), linear-gradient(135deg,#070b17,#111827,#1e0f2f);
        }
        ...
        .showcase-card {
          ...
          padding:44px;
          background:
            radial-gradient(circle at 20% 20%,#f472b666,transparent 35%),
