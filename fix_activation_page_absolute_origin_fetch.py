...
backup = BACKUPS / f"activate_page_before_absolute_origin_fetch_{stamp}.tsx"
...
if old not in text:
    raise SystemExit("TARGET_FETCH_BLOCK_NOT_FOUND")

text = text.replace(old, new)

PAGE.write_text(text, encoding="utf-8")

print("ACTIVATION_PAGE_ABSOLUTE_ORIGIN_FETCH_FIXED")
