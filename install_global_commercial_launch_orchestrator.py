...
target = runtime_dir / "global_commercial_launch_orchestrator.py"

backup_dir = Path("backups") / ("global_commercial_launch_before_" + datetime.now().strftime("%Y%m%d_%H%M%S"))
...
print("GLOBAL_COMMERCIAL_LAUNCH_ORCHESTRATOR_INSTALLED")
