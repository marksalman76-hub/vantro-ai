...
target = runtime_dir / "global_beta_readiness_orchestration.py"

backup_dir = Path("backups") / ("global_beta_readiness_before_" + datetime.now().strftime("%Y%m%d_%H%M%S"))
...
print("GLOBAL_BETA_READINESS_ORCHESTRATION_INSTALLED")
