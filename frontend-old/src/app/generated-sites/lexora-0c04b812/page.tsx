      ...
      <section className="hero">
        ...
        <div className="left">
          ...
          <div className="eyebrow">
            Client Confidence · legal_trust
          </div>

          <h1>Clear Legal Guidance When The Stakes Matter.</h1>

          <p>A trust-first legal website experience designed for confidential enquiries, service clarity, and consultation conversion.</p>
      ...
      <style>{`
        ...
        * {
        ...
        .shell {
          ...
          background:
            radial-gradient(circle at top left,#f5c76b55,transparent 35%),
            radial-gradient(circle at bottom right,#ffffff22,transparent 25%),
            radial-gradient(circle at 75% 15%, #f5c76b44, transparent 28%), linear-gradient(135deg,#080807,#17120a,#111827);
        }
        ...
        .showcase-card {
          ...
          padding:44px;
          background:
            radial-gradient(circle at 20% 20%,#f5c76b66,transparent 35%),
