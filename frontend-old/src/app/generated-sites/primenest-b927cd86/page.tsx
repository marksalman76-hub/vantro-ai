      ...
      <section className="hero">
        ...
        <div className="left">
          ...
          <div className="eyebrow">
            Property Campaign · property_editorial
          </div>

          <h1>Luxury Waterfront Campaigns Built To Dominate Attention.</h1>

          <p>High-conversion property campaign architecture for premium listings.</p>
        ...
        * {
        ...
        .shell {
          ...
          background:
            ...
            radial-gradient(circle at 80% 10%, #f5c76b55, transparent 30%), linear-gradient(135deg,#0b0906,#1c160d,#111827);
        }
