      ...
      <section className="hero">
        ...
        <div className="left">
          ...
          <div className="eyebrow">
            Platform Modules · dashboard_command
          </div>

          <h1>A Smarter Platform Experience Built For Scale.</h1>

          <p>A premium SaaS command-centre landing page with dashboard-style proof, workflow clarity, and demo conversion.</p>
      ...
      <style>{`
        ...
        * {
        ...
        .shell {
          ...
          background:
            radial-gradient(circle at top left,#a78bfa55,transparent 35%),
            radial-gradient(circle at bottom right,#ffffff22,transparent 25%),
            radial-gradient(circle at 15% 15%, #a78bfa66, transparent 30%), linear-gradient(135deg,#050816,#111827,#1e1b4b);
        }
        ...
        .showcase-card {
          ...
          padding:44px;
          background:
            radial-gradient(circle at 20% 20%,#a78bfa66,transparent 35%),
