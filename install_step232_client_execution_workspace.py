...
backup = BACKUPS / f"client_page_before_step232_{timestamp}.tsx"
backup.write_text(CLIENT_PAGE.read_text(encoding="utf-8"), encoding="utf-8")

CLIENT_PAGE.write_text(r'''
"use client";
...
py_compile.compile(str(ROOT / "install_step232_client_execution_workspace.py"), doraise=True)

print("STEP_232_CLIENT_EXECUTION_WORKSPACE_INSTALLED")
