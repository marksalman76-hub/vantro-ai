...
def test_admin_only_provider_diagnostics_panel():
    ...
    assert "Open diagnostics" in panel, "open diagnostics button missing"
...
def test_client_portal_provider_diagnostics_removed():
    ...
    assert "DirectMediaProviderPanel intentionally removed from client portal" in client, "client portal should document removal"
